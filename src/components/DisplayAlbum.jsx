  ...
  return albumData ? (
    <>
      ...
      <div className='p-4 flex'>
        <img className='absolute overflow-hidden w-[5rem] h-[5rem] bg-[hsl(0,0%,98.4%,0.2)] bg-fixed opacity-80 transition duration-300 ease-in-out hover:opacity-100 cursor-pointer' onClick={playAlbum} src={assets.playAlbum} alt="" />
      </div>
